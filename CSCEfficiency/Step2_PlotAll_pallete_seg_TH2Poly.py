...
#TagProbeFitResult="2015D_allTill1311_seg_newAlign_withHLTIsoTkMu_matchOtherStationsORME13_chambers/TnP_"+dir_+"_"
#TagProbeFitResult="2015B_newAlign/TnP_"+dir_+"_"
...
#    LCTCanvas.Write(LCTEff) # problem!
    print "place 2a"
    LCTCanvas.SaveAs("LCTCanvas_2D_testing.pdf")
