...
TemporaryOutputFile_TnP=ClassifiedTreeFile.replace("Tmp","TnP")
TemporaryOutputFile_TnP=TemporaryOutputFile_TnP.replace("ME","_ME")
...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName     = cms.string("%s" % (TemporaryOutputFile_TnP.replace(TemporaryOutputFile[:-5],"")) ), 
    ...
    Variables = cms.PSet(
        ...
        numberOfPrimaryVertices  = cms.vstring("PV", "0", "1000", ""),
...
EfficiencyBins = cms.PSet(
            ...
            tracks_e        = cms.vdouble(momentumbin),
            numberOfPrimaryVertices        = cms.vdouble(PVbin),
