  ...
  for (Int_t iiStation=0; iiStation < 8; iiStation++){
    for (Int_t iiRing=0; iiRing < 4; iiRing++){
      ...
      for (Int_t iiChamber=0; iiChamber< 37; iiChamber++){
        ...
        bool cond3 = ((iiStation==0||iiStation==4)&&(iiRing==0||iiRing==1));
        Int_t totDCFEBs;
        ...
        if (cond3 && iiChamber != 0){
          segEffME11CSCs->Fill(effStationRingChamberSeg[iiStation][iiRing][iiChamber]*100);
          LCTEffME11CSCs->Fill(effStationRingChamberLCT[iiStation][iiRing][iiChamber]*100);
        ...
        for (Int_t iiDCFEB=0; iiDCFEB< numDCFEBBins; iiDCFEB++){
          ...
          if ((totStationRingChamberDCFEB[iiStation][iiRing][iiChamber][iiDCFEB]>0.5)&&((totStationRingChamberDCFEB[iiStation][iiRing][iiChamber][iiDCFEB]-totSBStationRingChamberDCFEB[iiStation][iiRing][iiChamber][iiDCFEB])>0.5)) {
            ...
            effStationRingChamberDCFEBLCT[iiStation][iiRing][iiChamber][iiDCFEB] = (passStationRingChamberDCFEBLCT[iiStation][iiRing][iiChamber][iiDCFEB]-passSBStationRingChamberDCFEBLCT[iiStation][iiRing][iiChamber][iiDCFEB])/(totStationRingChamberDCFEBLCT[iiStation][iiRing][iiChamber][iiDCFEB]-totSBStationRingChamberDCFEB[iiStation][iiRing][iiChamber][iiDCFEB]);
            effSigmaStationRingChamberDCFEBLCT[iiStation][iiRing][iiChamber][iiDCFEB] = sqrt(((passStationRingChamberDCFEBLCT[iiStation][iiRing][iiChamber][iiDCFEB]+passSBStationRingChamberDCFEBLCT[iiStation][iiRing][iiChamber][iiDCFEB])*(1.-effStationRingChamberDCFEBLCT[iiStation][iiRing][iiChamber][iiDCFEB])*(1.-effStationRingChamberDCFEBLCT[iiStation][iiRing][iiChamber][iiDCFEB]))+ ((totStationRingChamberDCFEBLCT[iiStation][iiRing][iiChamber][iiDCFEB]-passStationRingChamberDCFEBLCT[iiStation][iiRing][iiChamber][iiDCFEB])+(totSBStationRingChamberDCFEB[iiStation][iiRing][iiChamber][iiDCFEB]-passSBStationRingChamberDCFEBLCT[iiStation][iiRing][iiChamber][iiDCFEB]))*effStationRingChamberDCFEBLCT[iiStation][iiRing][iiChamber][iiDCFEB]*effStationRingChamberDCFEBLCT[iiStation][iiRing][iiChamber][iiDCFEB])/(totStationRingChamberDCFEBLCT[iiStation][iiRing][iiChamber][iiDCFEB]-totSBStationRingChamberDCFEB[iiStation][iiRing][iiChamber][iiDCFEB]);
          }
	  ...
	  float bNumber = 0.0;
	    ...
	    bNumber = passStationRingPVSeg[iiStation][iiRing][iiPV];
	    //if (effStationRingPVSeg[iiStation][iiRing][iiPV] == 1.0) effSigmaStationRingPVSeg[iiStation][iiRing][iiPV] = sqrt(passStationRingPVSeg[iiStation][iiRing][iiPV])/passStationRingPVSeg[iiStation][iiRing][iiPV];
	    if (effStationRingPVSeg[iiStation][iiRing][iiPV] == 1.0) effSigmaStationRingPVSeg[iiStation][iiRing][iiPV] = sqrt((bNumber+1)/((bNumber+2)*(bNumber+2)*(bNumber+3)));
	    ...
	    //	    if (effStationRingPVLCT[iiStation][iiRing][iiPV] == 1.0) effSigmaStationRingPVLCT[iiStation][iiRing][iiPV] = sqrt(passStationRingPVLCT[iiStation][iiRing][iiPV])/passStationRingPVLCT[iiStation][iiRing][iiPV];
	    bNumber = passStationRingPVLCT[iiStation][iiRing][iiPV];
	    if (effStationRingPVLCT[iiStation][iiRing][iiPV] == 1.0) effSigmaStationRingPVLCT[iiStation][iiRing][iiPV] = sqrt((bNumber+1)/((bNumber+2)*(bNumber+2)*(bNumber+3)));
	    ...
	    //if (effStationCRingPVSeg[iiStation][iiRing][iiPV] == 1.0) effSigmaStationCRingPVSeg[iiStation][iiRing][iiPV] = sqrt(passStationRingPVSeg[iiStation][iiRing][iiPV])/passStationRingPVSeg[iiStation][iiRing][iiPV];
	    if (effStationCRingPVSeg[iiStation][iiRing][iiPV] == 1.0) effSigmaStationCRingPVSeg[iiStation][iiRing][iiPV] = effStationCRingPVSeg[iiStation][iiRing][iiPV] - TEfficiency::MidPInterval(totStationRingPV[iiStation][iiRing][iiPV]+totStationRingPV[iiStation+4][iiRing][iiPV],passStationRingPVSeg[iiStation][iiRing][iiPV]+passStationRingPVSeg[iiStation+4][iiRing][iiPV], 0.6827,0);	    
	    //std::cout << "Station " << iiStation << " Ring " << iiRing << " total " << totStationRingPV[iiStation][iiRing][iiPV]+totStationRingPV[iiStation+4][iiRing][iiPV] << " pass " <<  passStationRingPVSeg[iiStation][iiRing][iiPV]+passStationRingPVSeg[iiStation+4][iiRing][iiPV] << " lower bound " << effSigmaStationCRingPVSeg[iiStation][iiRing][iiPV] << " upper bound " << TEfficiency::MidPInterval(totStationRingPV[iiStation][iiRing][iiPV]+totStationRingPV[iiStation+4][iiRing][iiPV],passStationRingPVSeg[iiStation][iiRing][iiPV]+passStationRingPVSeg[iiStation+4][iiRing][iiPV], 0.6827,1) << std::endl;
	    ...
	    //if (effStationCRingPVLCT[iiStation][iiRing][iiPV] == 1.0) effSigmaStationCRingPVLCT[iiStation][iiRing][iiPV] = sqrt(passStationRingPVLCT[iiStation][iiRing][iiPV])/passStationRingPVLCT[iiStation][iiRing][iiPV];
	    if (effStationCRingPVLCT[iiStation][iiRing][iiPV] == 1.0) effSigmaStationCRingPVLCT[iiStation][iiRing][iiPV] = effSigmaStationCRingPVLCT[iiStation][iiRing][iiPV] = effStationCRingPVLCT[iiStation][iiRing][iiPV] - TEfficiency::MidPInterval(totStationRingPV[iiStation][iiRing][iiPV]+totStationRingPV[iiStation+4][iiRing][iiPV],passStationRingPVLCT[iiStation][iiRing][iiPV]+passStationRingPVLCT[iiStation+4][iiRing][iiPV], 0.6827,0);
	...
	if (iiStation < 4){	  
	  //TGraphAsymmErrors *graph1 = new TGraphAsymmErrors(segEffStationCRingPV[iiStation][iiRing]);
		  segEffStationCRingPVGraph[iiStation][iiRing] = new TGraphAsymmErrors(segEffStationCRingPV[iiStation][iiRing]);
		  LCTEffStationCRingPVGraph[iiStation][iiRing] = new TGraphAsymmErrors(LCTEffStationCRingPV[iiStation][iiRing]);
	  for (Int_t iiPV=0; iiPV< numPVBins; iiPV++){
	    //std::cout << "Graph tests eff Graph " << segEffStationCRingPVGraph[iiStation][iiRing]->GetPointY(iiPV) << " eff Hist " << effStationCRingPVSeg[iiStation][iiRing][iiPV] << std::endl;
	  segEffStationCRingPVGraph[iiStation][iiRing]->SetPointEYhigh(iiPV,TEfficiency::MidPInterval(totStationRingPV[iiStation][iiRing][iiPV]+totStationRingPV[iiStation+4][iiRing][iiPV],passStationRingPVSeg[iiStation][iiRing][iiPV]+passStationRingPVSeg[iiStation+4][iiRing][iiPV], 0.6827,1)-effStationCRingPVSeg[iiStation][iiRing][iiPV]);
	      segEffStationCRingPVGraph[iiStation][iiRing]->SetPointEYlow(iiPV,effStationCRingPVSeg[iiStation][iiRing][iiPV]-TEfficiency::MidPInterval(totStationRingPV[iiStation][iiRing][iiPV]+totStationRingPV[iiStation+4][iiRing][iiPV],passStationRingPVSeg[iiStation][iiRing][iiPV]+passStationRingPVSeg[iiStation+4][iiRing][iiPV], 0.6827,0));
																						   LCTEffStationCRingPVGraph[iiStation][iiRing]->SetPointEYhigh(iiPV,TEfficiency::MidPInterval(totStationRingPV[iiStation][iiRing][iiPV]+totStationRingPV[iiStation+4][iiRing][iiPV],passStationRingPVLCT[iiStation][iiRing][iiPV]+passStationRingPVLCT[iiStation+4][iiRing][iiPV], 0.6827,1)-effStationCRingPVLCT[iiStation][iiRing][iiPV]);
	      LCTEffStationCRingPVGraph[iiStation][iiRing]->SetPointEYlow(iiPV,effStationCRingPVLCT[iiStation][iiRing][iiPV]-TEfficiency::MidPInterval(totStationRingPV[iiStation][iiRing][iiPV]+totStationRingPV[iiStation+4][iiRing][iiPV],passStationRingPVLCT[iiStation][iiRing][iiPV]+passStationRingPVLCT[iiStation+4][iiRing][iiPV], 0.6827,0));
	  }

	  sprintf(name,"segEffPVStation%dCRing%dGraph",iiStation+1,iiRing);
	  segEffStationCRingPVGraph[iiStation][iiRing]->Write(name);
	  segEffStationCRingPVGraph[iiStation][iiRing]->Print();
	  sprintf(name,"LCTEffPVStation%dCRing%dGraph",iiStation+1,iiRing);
	  LCTEffStationCRingPVGraph[iiStation][iiRing]->Write(name);
