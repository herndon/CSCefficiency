...
Int_t nb = 500; 
 ...
 TString HistoNames[3]={"LCTEff","LCTEff_upErr","LCTEff_downErr"};
...
cms_label->AddText("CMS Preliminary 2016                                                                  #sqrt{s}=13 TeV,  L=4 fb^{-1}");
h2p->SetMarkerSize(0);
...
//     h2p->Draw("same,text");
   ...
   ch2p2->SaveAs("test.pdf");
    ch2p2->SaveAs("test.root");
    ch2p2->SaveAs("test.C");
