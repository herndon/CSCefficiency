...
config.General.requestName = 'CSCEff2023C0v4_v1'
config.General.workArea = ''
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'create_ntuple_crab_Run3Data_2023C0v4_v1.py'
...
config.Data.outputDatasetTag = 'CSCEff2023C0_2023_0628_1'
