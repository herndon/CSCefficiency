...
config.General.requestName = 'CSCEff2025G0_1_1'
config.General.workArea = ''
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'create_ntuple_crab_Run3Data_2025G_1.py'
...
config.Data.outputDatasetTag = 'CSCEff2025G0_1_251219_1'
