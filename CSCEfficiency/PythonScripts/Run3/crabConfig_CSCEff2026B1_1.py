...
config.General.requestName = 'CSCEff2026B1_1_1'
...
config.Data.inputDataset = '/Muon1/Run2026B-ZMu-PromptReco-v1/RAW-RECO'
...
config.Data.outputDatasetTag = 'CSCEff2026B1_1_260330_1'
