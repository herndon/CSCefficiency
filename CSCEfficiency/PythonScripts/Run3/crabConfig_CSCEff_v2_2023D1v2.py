...
config.General.requestName = 'CSCEff2023D1v2_v2'
config.General.workArea = ''
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'create_ntuple_crab_Run3Data_2023D1v2_v2.py'
config.JobType.maxMemoryMB = 2500 
config.JobType.allowUndistributedCMSSW = True

config.Data.inputDataset = '/Muon1/Run2023D-ZMu-PromptReco-v2/RAW-RECO'
...
config.Data.outputDatasetTag = 'CSCEff2023D1_2023_0721_1'
