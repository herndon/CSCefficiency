...
config.General.requestName = 'CSCEff2023D0v2_v2'
config.General.workArea = ''
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'create_ntuple_crab_Run3Data_2023D0v2_v2.py'
...
config.Data.outputDatasetTag = 'CSCEff2023D0_2023_0721_1'
