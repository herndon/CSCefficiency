...
config.General.requestName = 'CSCEff2022C_2'
config.General.workArea = ''
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'create_ntuple_crab_Run3Data_2022C.py'
...
config.Data.outputDatasetTag = 'CSCEff2022C_20220725_2'
