...
#                                                              'root://cms-xrd-global.cern.ch//store/data/Run2018D/SingleMuon/RAW-RECO/ZMu-PromptReco-v2/000/322/348/00000/B8A69D3C-64B4-E811-9E25-02163E014855.root'),
#)

#process.source = cms.Source("PoolSource",
                            #fileNames = cms.untracked.vstring('file:323492-32361586.root')
...
process.TFileService = cms.Service('TFileService',
 #   fileName = cms.string('CSCeff_SingleMuon_2018A_v1.root')
    fileName = cms.string('CSCEff2018A.root')
)   
