...
#)
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/data/Run2022B/SingleMuon/RAW-RECO/ZMu-PromptReco-v1/000/355/383/00000/07738631-166c-4793-b71d-bca9d2091d7e.root'),
    secondaryFileNames = cms.untracked.vstring()
)
